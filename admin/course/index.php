...
<body>
    ...
    <div class="blog-card">
        ...
        <h1 align="center" class="title">ข้อมูลหลักสูตร</h1>
            ...
            <div class="content content-1">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tr align="center">
                            <th witth="10%">ลำดับ</th>
                            <th width="70%">หลักสูตร</th>
...
$(document).ready(function() {
    ...
    $('.update_data').click(function() { //เมื่อมีการกดปุ่ม view_data
        var course_id = $(this).attr("id"); //รับค่า id จากปุ่มวิวมาใส่ไว้ใน uid
        $.ajax({
            url: "fetch.php",
            method: "post",
            data: {
    ...
    $('.delete_data').click(function() { //ตรวจสอบคลาส delete_data เมื่อมีการกดปุ่ม
        var course_id = $(this).attr("id"); //รับค่า id จากปุ่มdeleteมาใส่ไว้ใน uid
