...
try {
  $sql = "SELECT * FROM alumni WHERE state = 1 ";
...
<div class="blog-card">
    ...
    <h1 align="center" class="title">รายชื่อศิษย์เก่า</h1>
                        ...
                        <tr>
                            ...
                            <!-- <th>
                                <?php
                                    if ($data->state == 0) {
                                    ?>
                                <input type="button" name="view" value="รออนุมัติ" class="btn btn-warning approve"
                                    id="<?=$data->id;?>" />
                                <?php }else{ ?>
                                <input type="button" name="view" value="อนุมัติ" class="btn btn-success refuse"
                                    id="<?=$data->id;?>" />
                                <?php }?>
                            </th> -->
